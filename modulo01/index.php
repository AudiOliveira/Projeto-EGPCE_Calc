                    ...
                    <div class="col-md-10 col-sm-8 container-fluid">
                        ...
                        <div class="apresentacao">
                            ...
                            <div class="texto_apresentacao wow fadeIn animate__zoomIn">
                                ...
                                <strong>
                                Olá, Nome_Completo Seja bem-vindo ao curso Calc – 
                                    Intermediário e Avançado!</strong><br>
                                    No curso “Calc para Iniciantes”, você teve uma visão dos principais 
                                    comandos, guias, opções, formatações e funções iniciais. Agora, conhecerá novos elementos e mais funções disponíveis. 
                                    Trabalharemos durante nosso curso com a versão 5.4.2.2 do LibreOffice, mas você poderá utilizar qualquer outra versão. 
                                    Nesta aula, abordaremos conceitos sobre os modelos de pastas de trabalho e organização de dados.<br><strong> 
                                    Esperamos que você se dedique ao curso e tenha um bom aproveitamento!</strong></p>
